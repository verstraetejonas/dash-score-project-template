                                              ...
                                              children=[
                                                  html.Ul(
                                                      ...
                                                      children=[
                                                          ...
                                                          #         children=[
                                                          #             html.A(className='nav-link active text-light',
                                                          #                    href='/',
                                                          #                    children=['Home'])
                                                          #         ]),
                                                          *links
...
def sidebar(paths: List[PathUtil]):
    return html.Div(className='d-flex flex-column p-3 sticky-top bg-dark', children=[
        html.Ul(className='nav nav-pills flex-column mb-auto', children=[
            html.Li(children=[
                html.A(className='nav-link text-muted', href=x.url(), children=[x.pieces[-2]])
            ]) for x in paths
        ])
    ])
